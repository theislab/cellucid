...
test('footer publishes the one exact web build identity', () => {
  const documentOwner = createDocument(['2026-07-27.5']);
  assert.equal(publishWebBuildVersion(documentOwner), '2026-07-27.5');
  assert.equal(documentOwner.output.textContent, '2026-07-27.5');
  assert.equal(documentOwner.output.title, 'Website build 2026-07-27.5');
});
